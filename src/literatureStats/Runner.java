...
public class Runner {
    ...
    public static final a3algorithms.Verbosity VERBOSE = Verbosity.MAXIMUM;
    ...
    private static final boolean[] PRELIMINARY_CHECKS =
            new boolean[]{jdkAcceptable()// this is the only one in this program
            };
    ...
    private static int getJavaVersion() {
        return Integer.parseInt(System.getProperty("java.version").split("\\" +
                ".")[0]);
    }
